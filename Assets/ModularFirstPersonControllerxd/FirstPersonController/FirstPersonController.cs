    ...
    private void Update()
    {
        ...
        if (!PauseMenu.isPaused)
        {
            ...
            if (enableSprint)
            {
                ...
                {
                    // If the player is not holding down the sprint key, stop sprinting and start the recharge timer if necessary
                    isSprinting = false;
                    if (isSprintCooldown)
                    {
                ...
                {
                    // Regain sprint while not sprinting and not holding down the sprint key
